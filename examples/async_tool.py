"""Async tool support: `@guard` and `ChokepointInterceptor.acall()` both
...
from chokepoint import BLOCK, ChokepointInterceptor, GuardBlocked, guard
...
async def main() -> None:
    ...
    # ChokepointInterceptor.acall(): the interceptor-based equivalent, useful when
