...
one-line ``::: chokepoint.<module>`` directive that mkdocstrings expands from the
...
REPO = "https://github.com/pedromuracchini/chokepoint/blob/main"
...
REFERENCE_MODULES = [
    ("chokepoint", "Package API"),
    ("chokepoint.core.context", "GuardContext"),
    ("chokepoint.core.decorator", "guard"),
    ("chokepoint.core.interceptor", "ChokepointInterceptor"),
    ("chokepoint.core.policy_set", "Policy and PolicySet"),
    ("chokepoint.core.reversible", "ReversibleAction"),
    ("chokepoint.core.escalation", "Escalation interface"),
    ("chokepoint.decisions", "Decisions"),
    ("chokepoint.state", "CallState"),
    ("chokepoint.redaction", "Redaction"),
    ("chokepoint.policies", "Policy library"),
    ("chokepoint.escalation", "Escalation handlers"),
    ("chokepoint.adapters", "Framework adapters"),
    ("chokepoint.multiagent", "Multi-agent"),
    ("chokepoint.ledger", "Ledger"),
    ("chokepoint.report", "Reports"),
    ("chokepoint.linter", "Linter"),
    ("chokepoint.otel", "OpenTelemetry"),
    ("chokepoint.testing", "Testing utilities"),
]
