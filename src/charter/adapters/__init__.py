...
`CharterInterceptor.use()` or `charter.wrap()` is called) never requires
...
from charter.adapters.base import register_adapter
from charter.adapters.langgraph import LangGraphAdapter
from charter.adapters.mcp import MCPAdapter
from charter.adapters.openai_agents import OpenAIAgentsAdapter
