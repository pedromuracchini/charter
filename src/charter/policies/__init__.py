...
Every policy elsewhere in Charter is something you write: `PolicySet(...)` plus
...
policies exactly like anything you'd write by hand.
    ...
    from charter.policies import no_secrets_in_args, path_within, rate_limit_policy
...
from charter.policies.cost import (
    extract_usage,
    token_budget_policy,
    token_cost,
    token_count,
...
from charter.policies.destructive import no_destructive_shell, no_destructive_sql
from charter.policies.limits import budget_policy, rate_limit_policy
from charter.policies.network import domain_allowlist, host_allowed
from charter.policies.paths import is_within, path_within
from charter.policies.secrets import find_secrets, no_secrets_in_args
