...
from chokepoint.core.policy_set import Hook
from chokepoint.decisions import BLOCK, Decision
...
def delegation_depth(ctx: GuardContext) -> int:
    ...
    `ChokepointInterceptor._self_inclusive_chain`), so a call an agent makes
