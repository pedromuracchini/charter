...
from chokepoint._safety import safe_call
...
from chokepoint.decisions import BLOCK, Decision, RuleResult, Severity
from chokepoint.errors import ConfigurationError

logger = logging.getLogger("chokepoint.policy")
...
class AgentScopedPolicy(Policy):
    ...
    Args:
        ...
        allowed_roles: Caller roles permitted to make the call. Any other
            ...
            `chokepoint lint` reports that wiring mistake.
