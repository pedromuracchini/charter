...
module *blocks the call*; `chokepoint.redaction` *scrubs the record* of calls
that were allowed to proceed. Both read `SECRET_PATTERNS` from
`chokepoint.redaction`, so adding a pattern improves both at once.
"""
...
from chokepoint.redaction import SECRET_PATTERNS
