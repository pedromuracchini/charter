...
Every policy elsewhere in Chokepoint is something you write: `PolicySet(...)` plus
...
policies exactly like anything you'd write by hand.
    ...
    from chokepoint.policies import no_secrets_in_args, path_within, rate_limit_policy
...
from chokepoint.policies.cost import (
    extract_usage,
    token_budget_policy,
    token_cost,
    token_count,
...
from chokepoint.policies.destructive import no_destructive_shell, no_destructive_sql
from chokepoint.policies.limits import budget_policy, rate_limit_policy
from chokepoint.policies.network import domain_allowlist, host_allowed
from chokepoint.policies.paths import is_within, path_within
from chokepoint.policies.secrets import find_secrets, no_secrets_in_args
